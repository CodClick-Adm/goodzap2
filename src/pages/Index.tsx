...
const plans = [
  {
    name: "Starter",
    price: "147",
    description: "Automatize respostas e ganhe tempo no WhatsApp<br>Ideal para empresas que recebem muitas perguntas repetidas e precisam responder rápido, sem depender de um atendente o tempo todo",
